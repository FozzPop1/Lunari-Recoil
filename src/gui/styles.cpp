...
void DefualtDarkStyle() {
	...
	style.Colors[ImGuiCol_WindowBg] = ImVec4(0.0627451f, 0.06666667f, 0.08627451f, 0.8f);
	...
	style.Colors[ImGuiCol_FrameBg] = ImVec4(0.3, 0.3, 0.3, 0.5);
	style.Colors[ImGuiCol_FrameBgHovered] = ImVec4(0.3, 0.3, 0.3, 0.5);
	style.Colors[ImGuiCol_FrameBgActive] = ImVec4(0.3, 0.3, 0.3, 0.5);
	...
	style.Colors[ImGuiCol_Button] = ImVec4(0.3, 0.3, 0.3, 0.5);
	style.Colors[ImGuiCol_ButtonHovered] = ImVec4(0.5f, 0.5f, 0.5f, 0.5);
	style.Colors[ImGuiCol_ButtonActive] = ImVec4(0.5f, 0.5f, 0.5f, 0.5);
	style.Colors[ImGuiCol_Header] = ImVec4(0.3, 0.3, 0.3, 0.5);
	style.Colors[ImGuiCol_HeaderHovered] = ImVec4(0.3, 0.3, 0.3, 0.5);
	style.Colors[ImGuiCol_HeaderActive] = ImVec4(0.3, 0.3, 0.3, 0.5);
	...
	style.Colors[ImGuiCol_CheckboxSelectedBg] = ImVec4(0.3, 0.3, 0.3, 0.5);
}